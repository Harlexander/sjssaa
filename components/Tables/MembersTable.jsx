    ...
    <table className='table-responsive w-full divide-y'>
        <thead className='font-manrope text-xs uppercase text-left'>
            <tr>
                ...
                <th className='py-2 whitespace-nowrap pr-4 font-light'>Mobile</th>
        ...
        <tbody className='divide-y font-figtree text-xs'>
            <tr className=''>
                <td className='py-4 whitespace-nowrap pr-4'>45165171</td>
                <td className='py-4 whitespace-nowrap pr-4'>Dunkwu Alexander</td>
                <td className='py-4 whitespace-nowrap pr-4'>dunkwualex6@gmail.com</td>
                <td className='py-4 whitespace-nowrap pr-4'>0818298291</td>
                <td className='py-4 whitespace-nowrap pr-4'>26th May, 2023</td>
                <td className='py-4 whitespace-nowrap pr-4'>Lagos</td>
