...
const HeroCarousel = () => {
  return (
    ...
    <div id="heroImage" className="flex flex-col h-full space-y-10 px-5 md:text-left text-center justify-center md:px-24 bg-gray-400 dark:bg-gray-700 dark:text-white">
        <Fade>
        <p className='font-primary md:text-6xl text-3xl text-pry'>St. Joseph Secondary School Alumni Association (SJSSAA), Surulere Lagos.</p>
